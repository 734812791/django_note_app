...
def hello_world(request):
    return HttpResponse('<h1 style="background-color:red";>hello world from entryapp<h1>')

def world(request):
    return HttpResponse('<h1 style="background-color:red";>world from entryapp<h1>')
